...
Please use the citation generated from [CITATION.cff](CITATION.cff). On [GitHub](https://github.com/grezniczek/redcap_easy_imagemap), select **Cite this repository** for ready-to-use citation formats.
